...
def main() -> None:
    ...
    truth = {
        ...
        for item in json.loads(args.source.read_text(encoding="utf-8"))
    }
    ...
    result = {
        ...
        "financial_reconciliation_percent": round(
            sum(item.reconciled for item in extracted) / len(extracted) * 100, 2
        ),
